...
namespace AndroidLib
{
    public class ResourceManager
    {
        ...
        public static string abePath = @"C:\Windows\abe.jar"; //If binary is in an environment path just set it to "abe.jar" otherwise it has to be fullpath with filename
    }
}
